...
class LoginController extends ResponseController
{
    public function loginAction(Request $request)
    {
        ...
        return $this->render('AehpartaSecurityBundle:Login:login.html.twig', $data);
    }
    ...
    public function registerAction(Request $request)
    {
        ...
        if ($method == 'POST') {
            ...
            return $this->render('AehpartaSecurityBundle:Login:error.html.twig', $data);
        }

        $data['error'] = $error;

        return $this->render('AehpartaSecurityBundle:Login:register.html.twig', $data);
    }
    ...
    public function resetAction(Request $request)
    {
        ...
        return $this->render('AehpartaSecurityBundle:Login:reset.html.twig', $data);
    }
}
